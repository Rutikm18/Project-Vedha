/**
 * Method-complete BFF transport for the engagement portal. Authentication and
 * scope authorization remain backend responsibilities; this route only carries
 * the portal session and preserves request/response semantics.
 */
