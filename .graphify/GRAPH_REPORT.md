...
## Corpus Check
- Large corpus: 1388 files · ~1,320,501 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 13246 nodes · 25571 edges · 761 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2776 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 5414 · calls: 4628 · rationale_for: 3734 · method: 3164 · uses: 2776 · MODIFIES: 2367 · ON_BRANCH: 1721 · imports: 661 · imports_from: 652 · inherits: 294 · PARENT_OF: 160


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1388 · Candidates: 3342
- Excluded: 1 untracked · 66077 ignored · 11 sensitive · 1 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `6b41065`
...
Cohesion: 0.01
Nodes (145): BloodHoundCollector — wrapper around the BloodHound.py collector + a Neo4j inges, NTLMRelayChecker — detect missing SMB/LDAP signing that enables NTLM relay.  NTL, hw_bind.py — hardware fingerprinting for binary host-locking.  The compiled bina, agent — the probe transport layer (sealed, push-driven, hardware-bound).  Archit, result_spool.py — local result persistence with upload retry.  When the probe co, bytes_to_pubkey_b64(), generate_identity(), pubkey_to_bytes() (+137 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (151): PROFILE_TOOLS, ModuleCategory, ModuleInput, ModuleOutput, modulesForPorts(), ScanModule, bySeverityCount(), runScan() (+143 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (95): AssistantReply, STARTERS, Turn, 2c38782 docs: spec CVE-breadth phase — snapshot must answer for every recognized product, 6b41065 probe fixed, 7a637eb feat: network VA accuracy, KEV exploitability, and console parity, 8f6bf49 Refactor code structure and remove redundant sections for improved readability and maintainability, PageShellProps (+87 more)
...
Cohesion: 0.02
Nodes (76): AssistantFab(), useAssistant(), ComplianceRef, COVERAGE_COLOR, CVSS_AGGRAVATING, CVSS_METRIC, CvssMetric, decisionDrivers() (+68 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (57): 6e2818f Add support for additional service scans and enhance routing logic- Introduced new port sets for SSH, LDAP, SMB enumeration, DNS, NFS, FTP, Rsync, VNC, IPMI, SMTP, MSRPC, and Printer services.- Updated profile deep branches to include new services for IT and IoT profiles.- Enhanced the routing logic to identify SSH service banners accurately.- Implemented scanning functionality for new services in the workflow engine, ensuring proper handling of open ports and service eligibility.- Adjusted the gate logic to accommodate the new services, allowing for more comprehensive asset scanning., cve — vulnerability (CVE) correlation layer.  SEPARATE from the probe's collecti, _extract_version(), cpe.py — derive a CPE 2.3 identity from an observed (service, product, version)., Prefer an explicit version field; else pull a version-like token out of the, Return {vendor, product, version, cpe23} for a recognized product, else None., to_cpe(), service_banner.py — grab service banners and identify the service behind a port. (+49 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (65): AssistantCtx, Ctx, CampaignSummary, EngagementSummary, 42f4e28 feat: enhance security operations UX and risk workflows, 7d8d3f3 merge: resolve conflicts with origin/ui-ux-backend-updates0109, f473173 merge: network VA accuracy, KEV exploitability, console parity (addcapabilities-fable), ActivityItem (+57 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (61): d98f654 feat(manager): network-VA campaign, finding lifecycle timeline, AI lifecycle grounding, vedha-agent rename, ENGAGEMENT_STATES, EngagementStatusControl(), EngagementStatusControlProps, STATUS_COLOR, PageShell(), ToastContext, ClientUserResp (+53 more)
...
Cohesion: 0.03
Nodes (89): _agent_can_execute_job(), _agent_ownership_check(), AgentBootstrapRequest, bootstrap_agent(), cancel_agent_job(), _encrypt_scope_for_agent(), enqueue_agent_job(), get_agent_job_history() (+81 more)
...
Cohesion: 0.04
Nodes (51): DEMO_ASSET, DEMO_ENGAGEMENT, DEMO_FINDING, AssetInput, chat(), CRITICALITY_SCORE, DESTRUCTIVE_PATTERNS, EPSS_MOCK (+43 more)
...
Cohesion: 0.05
Nodes (47): BaseModel, AiGenerateResponse, AiMessage, AssetIn, AssetOut, BulkAssetImportResult, LoginRequest, PersonalAccessTokenCreate (+39 more)
...
Cohesion: 0.16
Nodes (53): addcapabilities-fable, feat/nvd-vuln-detection-and-ingest-hardening, main, ui-ux-backend-updates0109, 00c6648 feat(settings): editable email/Slack/Jira integrations wired to backend (item 3 UI), 0236a60 fix(detection): full EPSS catalog so exploit-probability isn't blind, 027f4e4 feat(integrations): per-tenant email/Slack/Jira config store + CRUD (item 3 backend), 185e648 docs: pending-work inventory (buckets A-G) (+45 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (45): main(), _print_table(), explain_plan.py — "which scanners will run against this host, and WHY?"      pyt, Recreate this branch's decision and say, in one line, what drove it., _why(), TLS branch coverage — the gap behind `tls_scan: invocations: 0`.  A real scan of, Why widening is safe.      A port that does not speak TLS yields `status="error", test_refused_handshake_is_an_error_not_a_false_negative() (+37 more)
...
Cohesion: 0.04
Nodes (36): _fetch(), _NoRedirect, parse_allow_header(), web_scanner.py — passive HTTP(S) service fingerprinting.  METHOD (collection onl, Read the Allow header from an OPTIONS response. Read-only., Read the Allow header from an OPTIONS response. Read-only., _open(), test_router_signals.py — router.py consumes service_banner's POSITIVE signals (t (+28 more)
...
Cohesion: 0.08
Nodes (42): Base, DeclarativeBase, AgentRecommendation, agent_recommendation.py — decisions/actions proposed by the agentic AI advisor., AttackTimeline, Append-only ledger of every attack action performed during an engagement.      W, Base, TimestampMixin (+34 more)
...
Cohesion: 0.04
Nodes (12): port_scanner.py — TCP connect scan with an evidence-based state engine.  METHOD, Resolve a named scan profile to a concrete, de-duplicated port list.      'full', Resolve a named scan profile to a concrete, de-duplicated port list.      'full', Resolve a named scan profile to a concrete, de-duplicated port list.      'full', Resolve a named scan profile to a concrete, de-duplicated port list.      'full', resolve_profile(), test_fd_limit.py — FIX 1: ulimit-aware concurrency for full-range scans.  A full, test_tarpit.py — tarpit / honeypot detection (task C5).  A tarpit (LaBrea), hone (+4 more)
...
Cohesion: 0.06
Nodes (40): _classify_connection_error(), _dbg(), _enroll_device(), main(), _manager_reachable(), _obtain_identity(), _poll_jobs_or_empty(), Request UI approval, poll, prove key possession, and activate. (+32 more)
...
Cohesion: 0.08
Nodes (23): AdvisorFlow(), PATCH_PILL, AssistantDrawer(), ExplainResponse, Msg, Served, AssistantText(), AiStatus (+15 more)
...
Cohesion: 0.09
Nodes (18): AssetCriticality, FindingEventType, A single entry in a finding's lifecycle audit trail. Stored as a plain     strin, UserRole, OrderedDict, str, parse_csv_assets(), Parse CSV text into a list of AssetIn models and error strings. (+10 more)
...
Cohesion: 0.08
Nodes (29): Persistent WebSocket push loop.      Returns False if WebSocket is unavailable (, Persistent WebSocket push loop.      Returns False if WebSocket is unavailable (, Persistent WebSocket push loop.      Returns False if WebSocket is unavailable (, Persistent WebSocket push loop.      Returns False if WebSocket is unavailable (, Persistent WebSocket push loop.      Returns False if WebSocket is unavailable (, Persistent WebSocket push loop.      Returns False if WebSocket is unavailable (, Poll pending jobs even while WS is connected.      This makes result delivery re, Poll pending jobs even while WS is connected.      This makes result delivery re (+21 more)
...
Cohesion: 0.09
Nodes (18): EnrollmentRequestNotFound, manager_fingerprint(), Stable identity for the manager a credential belongs to.      Device credentials, HTTP (+ future WebSocket) transport to the manager.      Thread-safe for sequent, HTTP (+ future WebSocket) transport to the manager.      Thread-safe for sequent, HTTP (+ future WebSocket) transport to the manager.      Thread-safe for sequent, HTTP (+ future WebSocket) transport to the manager.      Thread-safe for sequent, Backwards-compatible bool wrapper over `refresh_device_access_ex`. (+10 more)
...
Cohesion: 0.09
Nodes (20): GzipRequestMiddleware, Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard. (+12 more)
...
Cohesion: 0.09
Nodes (20): Poll for pending jobs (HTTP fallback for WebSocket).          Returns a list of, Generic authenticated GET, returns parsed JSON or None on failure.          Used, Establish an authenticated WebSocket connection to the manager.          Returns, Poll for pending jobs (HTTP fallback for WebSocket).          Returns a list of, Poll for pending jobs (HTTP fallback for WebSocket).          Returns a list of, Refresh a device token before expiry; legacy identities are unchanged., Generic authenticated GET, returns parsed JSON or None on failure.          Used, Establish an authenticated WebSocket connection to the manager.          Returns (+12 more)
...
Cohesion: 0.10
Nodes (18): _atomic_write_private_state(), Durably replace one private JSON state file without exposing secrets., Merge and atomically persist private state while preserving fields., Merge and atomically persist private state while preserving fields., Merge and atomically persist private state while preserving fields., Merge and atomically persist private state while preserving fields., Refresh routing metadata using the cached agent identity.          Returns True, Merge and atomically persist private state while preserving fields. (+10 more)
...
Cohesion: 0.18
Nodes (7): A host that rate-limits its RSTs answers only when probed gently. The     fast s, Silent for the first `answer_after` probes per port, then a real RST., Corrected ports must be recorded ONCE, with their final state., A converged estimator can be tuned to a path that was dropping us., _scanner(), TestConnectCongestionWindow, TestReprobeCleanupPass

### Community 155 - "Community 155"
Cohesion: 0.12
Nodes (11): test_service_banner_ident.py — the service-identification upgrade.  Covers: the, A speak-first daemon that delays its 220 (reverse-DNS stall) must not be     rep, The banner and the match must come from the SAME rung (an earlier, longer     bu, The HTTPS-on-9443 case: plaintext rungs see nothing useful, the TLS rung     com, _scanner(), _self_signed(), test_https_on_arbitrary_port_identifies_and_flags_tls(), test_matched_rung_banner_is_the_one_reported() (+3 more)
...
Cohesion: 0.11
Nodes (20): apply_manual_reopen(), build_coverage(), decide_resolution(), evaluate_resolutions(), host_of(), resolution.py — coverage-gated auto-resolution of findings.  Split into a PURE c, Operator reopens an auto/'manually'-resolved finding. Mirrors the engine's     r, Operator reopens an auto/'manually'-resolved finding. Mirrors the engine's     r (+12 more)
...
Cohesion: 0.10
Nodes (7): test_dualstack_fallback.py — roadmap #9 / #4.1, the CALL-SITE migration.  `resol, TestOsFingerprintSmbBuildFallback, TestRdpFallback, TestResolveIpCandidates, TestSmbNtlmFallback, TestSynScannerRequestsIPv4, TestTlsFingerprintFallback
...
Cohesion: 0.11
Nodes (18): _load_or_create_identity(), Load the probe's X25519 identity from persistent state, or create one.      Retu, Load the probe's X25519 identity from persistent state, or create one.      Retu, Release a staged job only after the manager confirms its claim., Release a staged job only after the manager confirms its claim., Release a staged job only after the manager confirms its claim., Release a staged job only after the manager confirms its claim., Load the probe's X25519 identity from persistent state, or create one.      Retu (+10 more)
...
Cohesion: 0.12
Nodes (17): _job_intent(), Human label for what a job will actually run — the use-case (real intent),     n, Human label for what a job will actually run — the use-case (real intent),     n, One-line, transparent summary of what a scan actually found so the operator, One-line, transparent summary of what a scan actually found so the operator, One-line, transparent summary of what a scan actually found so the operator, Run one job while keeping WS status/result frames best-effort., Run one job while keeping WS status/result frames best-effort. (+9 more)

### Community 228 - "Community 228"
Cohesion: 0.12
Nodes (17): _load_or_create_signing_identity(), Load or atomically create the probe's Ed25519 enrollment identity., Load or atomically create the probe's Ed25519 enrollment identity., Load or atomically create the probe's Ed25519 enrollment identity., Load or atomically create the probe's Ed25519 enrollment identity., Run all startup security checks before any network I/O.      Order matters: HW b, Run all startup security checks before any network I/O.      Order matters: HW b, Run all startup security checks before any network I/O.      Order matters: HW b (+9 more)

### Community 229 - "Community 229"
Cohesion: 0.14
Nodes (15): AgentDeps, AgentOpts, configure_logging(), isBlocked(), Install a root log handler for the daemon.      Nothing on the daemon path calle, Install a root log handler for the daemon.      Nothing on the daemon path calle, requiresApproval(), runAutonomousEngagement() (+7 more)

### Community 230 - "Community 230"
Cohesion: 0.12
Nodes (15): Fetch the engagement's authoritative scope.          Returns the response dict i, Fetch the engagement's authoritative scope.          Returns the response dict i, Fetch the engagement's authoritative scope.          Returns the response dict i, True if the WebSocket connection is active., True if the WebSocket connection is active., Fetch the engagement's authoritative scope.          Returns the response dict i, Fetch the engagement's authoritative scope.          Returns the response dict i, Fetch the engagement's authoritative scope.          Returns the response dict i (+7 more)
...
Cohesion: 0.13
Nodes (13): Durably replace one private JSON state file without exposing secrets., Register the probe with the manager.          Args:             name: Probe name, Register the probe with the manager.          Args:             name: Probe name, Register the probe with the manager.          Args:             name: Probe name, Register the probe with the manager.          Args:             name: Probe name, Register the probe with the manager.          Args:             name: Probe name, Register using a manager-side shared bootstrap key (no user login needed)., Register using a manager-side shared bootstrap key (no user login needed). (+5 more)

### Community 251 - "Community 251"
Cohesion: 0.14
Nodes (13): Send a heartbeat to the manager.          Returns True if the heartbeat was acce, Send a heartbeat to the manager.          Returns True if the heartbeat was acce, Send a heartbeat to the manager.          Returns True if the heartbeat was acce, Refresh a device token before expiry; legacy identities are unchanged., Refresh a device token before expiry; legacy identities are unchanged., Send a heartbeat to the manager.          Returns True if the heartbeat was acce, Send a heartbeat to the manager.          Returns True if the heartbeat was acce, Refresh a device token before expiry; legacy identities are unchanged. (+5 more)
...
Cohesion: 0.14
Nodes (14): _bounded_env_int(), Run an HTTP-claimed job while renewing its manager lease., Run an HTTP-claimed job while renewing its manager lease., Run an HTTP-claimed job while renewing its manager lease., Run an HTTP-claimed job while renewing its manager lease., Return an integer environment setting constrained to a safe range., Return an integer environment setting constrained to a safe range., Return an integer environment setting constrained to a safe range. (+6 more)
...
Cohesion: 0.14
Nodes (14): _finding_detail_out(), finding_timeline(), get_finding(), patch_finding(), Operator reverses a resolution (auto or manual). Only a `remediated`     finding, Operator reverses a resolution (auto or manual). Only a `remediated`     finding, Operator reverses a resolution (auto or manual). Only a `remediated`     finding, The finding's full lifecycle, oldest-first: stored audit events (who did     wha (+6 more)
...
Cohesion: 0.19
Nodes (13): build_connection_request(), parse_connection_confirm(), _posture_from_selected(), probe_rdp(), probe_rdp_posture(), Two-probe RDP posture (MS-RDPBCGR 2.2.1.1.1 / 2.2.1.2.1).      Probe A offers SS, TPKT + X.224 Connection Request carrying an RDP Negotiation Request., TPKT + X.224 Connection Request carrying an RDP Negotiation Request. (+5 more)
...
Cohesion: 0.15
Nodes (9): Discovery results → assets/services promotion (makes the Attack Surface populate, A single web scan can emit multiple facts for the same host:port., Discovery results → assets/services promotion (makes the Attack Surface populate, A single web scan can emit multiple facts for the same host:port., Discovery results → assets/services promotion (makes the Attack Surface populate, Discovery results → assets/services promotion (makes the Attack Surface populate, A single web scan can emit multiple facts for the same host:port., A single web scan can emit multiple facts for the same host:port. (+1 more)

### Community 318 - "Community 318"
Cohesion: 0.35
Nodes (4): _redis(), TestEnqueueAgentJob, TestOTProfileGate, _user()
...
Cohesion: 0.18
Nodes (8): test_host_health.py — mid-scan target-offline detection.  The interesting cases, TestConfiguration, _env_int(), _heartbeat_misses(), host_health.py — detect a target that was proven alive and has since gone away,, Consecutive silent components before we spend a re-check on this host., Consecutive missed heartbeats before a host is declared offline., _strike_threshold()
...
Cohesion: 0.17
Nodes (12): _build_run_stats(), _hosts_from_facts(), Build promotion-ready hosts without duplicating scanner facts per port., Build promotion-ready hosts without duplicating scanner facts per port., Build promotion-ready hosts without duplicating scanner facts per port., Build promotion-ready hosts without duplicating scanner facts per port., Build promotion-ready hosts without duplicating scanner facts per port., Build one consistent result summary for complete and interrupted runs. (+4 more)

### Community 331 - "Community 331"
Cohesion: 0.20
Nodes (12): _derive_devices(), _derive_exposure(), _derive_post_stage(), Return (extra ScanResults to append as facts, a top-level rollup dict).      Pur, Return (extra ScanResults to append as facts, a top-level rollup dict).      Pur, Return (extra ScanResults to append as facts, a top-level rollup dict).      Pur, Return (extra ScanResults to append as facts, a top-level rollup dict).      Pur, Classify each target's device role from its collected facts (no I/O).     Return (+4 more)

### Community 332 - "Community 332"
Cohesion: 0.17
Nodes (11): _enrollment_conflict_detail(), Best-effort extraction of the manager's 409 ``detail`` message., Best-effort extraction of the manager's 409 ``detail`` message., True if we have both an agent_id and a token for API calls., True if we have both an agent_id and a token for API calls., True if we have both an agent_id and a token for API calls., True if we have both an agent_id and a token for API calls., True if we have both an agent_id and a token for API calls. (+3 more)
...
Cohesion: 0.20
Nodes (8): _harvest_tcp_stack(), PortScanner, One connect() and its classification. Always returns a ScanResult         (open, One connect() and its classification. Always returns a ScanResult         (open, One connect() and its classification. Always returns a ScanResult         (open, One connect() and its classification. Always returns a ScanResult         (open, One port's terminal result, gated by the rate limiter and (when         enabled), Peer TCP-stack signals readable from a COMPLETED connect(), for OS/link     fing
...
Cohesion: 0.20
Nodes (11): _clamp(), _job_runtime_seconds(), Coerce val to float and clamp to [lo, hi]; fall back to default on junk.     Def, Return the effective whole-job deadline; callers can only reduce it., Coerce val to float and clamp to [lo, hi]; fall back to default on junk.     Def, Coerce val to float and clamp to [lo, hi]; fall back to default on junk.     Def, Coerce val to float and clamp to [lo, hi]; fall back to default on junk.     Def, Coerce val to float and clamp to [lo, hi]; fall back to default on junk.     Def (+3 more)

### Community 362 - "Community 362"
Cohesion: 0.20
Nodes (11): _facts_from_cache(), Execute a scan and return the enriched result bundle.      Args:         scan_ty, Execute a scan and return the enriched result bundle.      Args:         scan_ty, Execute a scan and return the enriched result bundle.      Args:         scan_ty, Execute a scan and return the enriched result bundle.      Args:         scan_ty, Execute a scan and return the enriched result bundle.      Args:         scan_ty, Execute a scan and return the enriched result bundle.      Args:         scan_ty, Execute a scan and return the enriched result bundle.      Args:         scan_ty (+3 more)

### Community 363 - "Community 363"
Cohesion: 0.18
Nodes (10): Submit a scan result to the manager.          Returns True ONLY on a 2xx respons, Recursively remove NUL (U+0000) characters from every string in a payload., Submit a scan result to the manager.          Returns True ONLY on a 2xx respons, Submit a scan result to the manager.          Returns True ONLY on a 2xx respons, Refresh routing metadata using the cached agent identity.          Returns True, Refresh routing metadata using the cached agent identity.          Returns True, Submit a scan result to the manager.          Returns True ONLY on a 2xx respons, Submit a scan result to the manager.          Returns True ONLY on a 2xx respons (+2 more)
...
Cohesion: 0.22
Nodes (9): fuse_liveness(), _now(), host_discovery.py — determine which hosts are alive, with graded confidence.  ME, PTR lookup; None on any failure. Runs in _RDNS_POOL, never on the loop., Combine TCP + neighbor signals into a confidence-scored verdict.      Returns a, Combine TCP + neighbor signals into a confidence-scored verdict.      Returns a, Combine TCP + UDP + neighbor signals into a confidence-scored verdict.      `udp, _reverse_dns() (+1 more)
...
Cohesion: 0.18
Nodes (10): classify_os_error(), _harvest_tcp_stack(), Map a connect()-time OSError to (state, reason).      DNS failures (socket.gaier, Map a connect()-time OSError to (state, reason).      DNS failures (socket.gaier, One connect() and its classification. Always returns a ScanResult         (open, One connect() and its classification. Always returns a ScanResult         (open, One connect() and its classification. Always returns a ScanResult         (open, One connect() and its classification. Always returns a ScanResult         (open (+2 more)
...
Cohesion: 0.18
Nodes (5): test_msrpc_scanner.py — MSRPC endpoint-mapper (EPM) enumeration.  Pure summary l, EPM bindings carry the dynamic RPC ports the funnel's fixed port set never     s, TestDynamicPorts, TestParity, TestSummarize
...
Cohesion: 0.20
Nodes (10): _check_anti_debug(), Detect common debugging/tracing tools.  Informational only — does     NOT block, Detect common debugging/tracing tools.  Informational only — does     NOT block, Detect common debugging/tracing tools.  Informational only — does     NOT block, Detect common debugging/tracing tools.  Informational only — does     NOT block, Detect common debugging/tracing tools.  Informational only — does     NOT block, Detect common debugging/tracing tools.  Informational only — does     NOT block, Detect common debugging/tracing tools.  Informational only — does     NOT block (+2 more)

### Community 389 - "Community 389"
Cohesion: 0.20
Nodes (10): Send periodic heartbeats over WebSocket., Send periodic heartbeats over WebSocket., Send periodic heartbeats over WebSocket., Send periodic heartbeats over WebSocket., Send periodic heartbeats over WebSocket., Send periodic heartbeats over WebSocket., Send periodic heartbeats over WebSocket., Send periodic heartbeats over WebSocket. (+2 more)

### Community 390 - "Community 390"
Cohesion: 0.20
Nodes (10): _applied_tuning(), syn' for wide sweeps (deep intensity / full-port audit), else 'connect'., syn' for wide sweeps (deep intensity / full-port audit), else 'connect'., syn' for wide sweeps (deep intensity / full-port audit), else 'connect'., Serialize effective limits without ever echoing credential values., Serialize effective limits without ever echoing credential values., Serialize effective limits without ever echoing credential values., Serialize effective limits without ever echoing credential values. (+2 more)
...
Cohesion: 0.20
Nodes (6): Bounded worker-pool scan of every requested port.          A fixed pool of `conc, Bounded worker-pool scan of every requested port.          A fixed pool of `conc, Bounded worker-pool scan of every requested port.          A fixed pool of `conc, True for the one state a retry can legitimately change: silence., Gentle second look at ports that stayed silent through the main sweep., Bounded worker-pool scan of every requested port.          A fixed pool of `conc
...
Cohesion: 0.31
Nodes (4): The probe polls forever; routine transport chatter must stay out of the     term, The actual regression: one INFO line per poll, every POLL_INTERVAL., Quieting must not hide a genuinely unreachable manager., TestPollingNoiseIsSuppressed
...
Cohesion: 0.22
Nodes (9): _flush_spool_over_http(), Retry durable result files using the acknowledged HTTP result path., Run one job while keeping WS status/result frames best-effort., Retry durable result files using the acknowledged HTTP result path., Retry durable result files using the acknowledged HTTP result path., Retry durable result files using the acknowledged HTTP result path., Retry durable result files using the acknowledged HTTP result path., Retry durable result files using the acknowledged HTTP result path. (+1 more)

### Community 429 - "Community 429"
Cohesion: 0.22
Nodes (8): DeviceAlreadyEnrolledError, Raised when a transport operation fails permanently (not retryable)., Raised when a transport operation fails permanently (not retryable)., Raised when a transport operation fails permanently (not retryable)., The probe's device signing key is already registered as an agent on the     mana, Raised when a transport operation fails permanently (not retryable)., The probe's device signing key is already registered as an agent on the     mana, TransportError

### Community 430 - "Community 430"
Cohesion: 0.22
Nodes (8): Return the WebSocket connection URL with auth token.          The token is passe, Return the WebSocket endpoint without embedding credentials.          Authentica, Return the WebSocket endpoint without embedding credentials.          Authentica, Return the WebSocket endpoint without embedding credentials.          Authentica, Return the WebSocket endpoint without embedding credentials.          Authentica, Return the WebSocket endpoint without embedding credentials.          Authentica, Return the WebSocket endpoint without embedding credentials.          Authentica, Return the WebSocket endpoint without embedding credentials.          Authentica
...
Cohesion: 0.25
Nodes (6): _fetch(), _NoRedirect, parse_allow_header(), web_scanner.py — passive HTTP(S) service fingerprinting.  METHOD (collection onl, Read the Allow header from an OPTIONS response. Read-only., Read the Allow header from an OPTIONS response. Read-only.
...
Cohesion: 0.25
Nodes (2): These may be transient/refreshable, so they must NOT read as a cancel         —, TestHeartbeatOutcomes
...
Cohesion: 0.29
Nodes (7): _count_open_port_facts(), Count concrete open services, not generic host-liveness observations., Count unique open network endpoints, not every confirming scanner fact., Count unique open network endpoints, not every confirming scanner fact., Count unique open network endpoints, not every confirming scanner fact., Count unique open network endpoints, not every confirming scanner fact., Count unique open network endpoints, not every confirming scanner fact.

### Community 494 - "Community 494"
Cohesion: 0.29
Nodes (7): LeaseLostError, Raised when Manager fencing revokes the running attempt., Raised when Manager fencing revokes the running attempt., Raised when Manager fencing revokes the running attempt., Raised when Manager fencing revokes the running attempt., Raised when Manager fencing revokes the running attempt., _run_with_cancellation()

### Community 495 - "Community 495"
Cohesion: 0.29
Nodes (7): Translate operator-supplied job params into run_engagement() kwargs.      This i, Return the effective whole-job deadline; callers can only reduce it., Translate operator-supplied job params into run_engagement() kwargs.      This i, Translate operator-supplied job params into run_engagement() kwargs.      This i, Translate operator-supplied job params into run_engagement() kwargs.      This i, Translate operator-supplied job params into run_engagement() kwargs.      This i, _tuning_from_params()
...
Cohesion: 0.43
Nodes (3): PortScanner, Emit a non-open result only when report_closed is on., One port's terminal result, gated by the rate limiter and (when         enabled)
...
Cohesion: 0.33
Nodes (6): _error_result(), Single factory for error result dicts — no copy-paste., Single factory for error result dicts — no copy-paste., Single factory for error result dicts — no copy-paste., Single factory for error result dicts — no copy-paste., _runtime_manifest()

### Community 538 - "Community 538"
Cohesion: 0.33
Nodes (6): check_hw_bind(), get_hw_id(), HWBindError, Raised when the binary is running on an unauthorized machine., Deterministic per-machine fingerprint built from stable hardware IDs.      Combi, Verify the binary is running on the machine it was compiled for.      Reads HW_B
...
Cohesion: 0.40
Nodes (5): _is_local_manager_url(), Recognize only explicit single-host development/Compose manager names., Recognize only explicit single-host development/Compose manager names., Recognize only explicit single-host development/Compose manager names., Recognize only explicit single-host development/Compose manager names.
...
Cohesion: 0.83
Nodes (3): classify_tier(), _evidence_scanners(), verify()
...
Cohesion: 0.50
Nodes (4): encrypt_scope(), encrypt_scope_b64(), Encrypt scope JSON to a specific probe's X25519 public key.      Args:         s, Convenience: dict → JSON → encrypt → base64 string.
...
Cohesion: 0.67
Nodes (3): merge_exclusions(), Merge engagement-level exclusions with per-job exclusions.      Returns a dedupl, Merge engagement-level exclusions with per-job exclusions.      Returns a dedupl
...
Cohesion: 0.67
Nodes (3): health_startup(), Returns the cached report from the last startup diagnostics run.     If the repo, Returns the cached report from the last startup diagnostics run.     If the repo
...
Cohesion: 0.67
Nodes (1): TestProbePayload

### Community 740 - "Community 740"
Cohesion: 0.67
Nodes (1): TestUserAgent
...
## Knowledge Gaps
- **3881 isolated node(s):** `Rule`, `vedha_ref.evidence_store -- the layer the whole strategy rests on.  Thesis under`, `Cluster observations into assets using fingerprint keys.      Strong keys merge`, `The industry default, for comparison. Included so the cost is measurable.`, `Answer a brand-new rule against evidence already on disk.      No network traffi` (+3876 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 137`** (1 nodes): `TestResultSpool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 184`** (1 nodes): `TestUDPProbeConstruction`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 222`** (1 nodes): `TestServiceIdentifier`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 243`** (1 nodes): `TestSNMPBerUtilities`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `TestMobileScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 297`** (1 nodes): `TestFingerprintOs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 298`** (1 nodes): `TestValidateTargetsInScope`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 321`** (1 nodes): `test_main_scripts_accuracy.py — Epic 6: the ground-truth accuracy harness.  Scor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 323`** (2 nodes): `_make_scan_record()`, `TestDeltaEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 326`** (1 nodes): `TestScopeGuard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 353`** (1 nodes): `TestAgentJobCompatibility`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 359`** (2 nodes): `Tests that use the real engine but with no-op callbacks.`, `TestRunnerHeadless`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 374`** (1 nodes): `TestADCSChecker`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 375`** (1 nodes): `TestVersionInRanges`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 379`** (1 nodes): `TestExpandTargets`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 380`** (2 nodes): `test_enroll_token_usable_only_while_live_unrevoked_and_under_max_uses()`, `_token()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 383`** (1 nodes): `TestSendPacer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 385`** (1 nodes): `TestNmapXMLParser`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 405`** (1 nodes): `TestGraphBuilder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 406`** (1 nodes): `TestVersion`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 407`** (2 nodes): `ipv6_discovery reports on the RUN, not a host: its target is the local         i`, `TestIngestFile`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 413`** (1 nodes): `TestClassifyDevice`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 415`** (1 nodes): `TestIoTScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 416`** (1 nodes): `TestStackSignature`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 417`** (1 nodes): `TestParsePorts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 418`** (1 nodes): `TestUseCasesResolve`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 420`** (2 nodes): `Each encryption uses a fresh ephemeral key, so blobs are different.`, `TestEncryptDecryptRoundtrip`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 423`** (1 nodes): `TestSubmitResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 440`** (1 nodes): `TestClassify`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 442`** (2 nodes): `The neighbour cache is system-wide. Pinging en0 and then harvesting every     in`, `TestInterfaceScoping`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 445`** (1 nodes): `TestTtlInference`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 448`** (1 nodes): `TestTargetsInExcludes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 449`** (1 nodes): `TestIdentity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 457`** (2 nodes): `ssh_collector.py — credentialed (authenticated) inventory collection for Linux.`, `SSHCollector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 469`** (1 nodes): `WindowsCollector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 472`** (1 nodes): `TestKerberoastChecker`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 475`** (1 nodes): `test_device_profile.py — the probe device_inventory → Asset role mapping.  Pure`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 478`** (2 nodes): `These may be transient/refreshable, so they must NOT read as a cancel         —`, `TestHeartbeatOutcomes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 480`** (1 nodes): `TestProvenance`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 482`** (2 nodes): `ipv6_discovery reports on the RUN (its target is an interface name, or         t`, `TestEngineSummary`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 483`** (1 nodes): `TestTuningFromParams`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 487`** (1 nodes): `TestBuildResultsEnrichment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 514`** (2 nodes): `CliProgressView`, `Renders campaign progress to a stream. On a TTY it re-draws one live block     i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 517`** (1 nodes): `TestBloodHoundCollector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 518`** (1 nodes): `TestDeceptionScore`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 519`** (1 nodes): `test_exposure.py — the probe exposure_matrix → Service verdict + severity bump.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 521`** (1 nodes): `TestDiscoverFiltering`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 522`** (1 nodes): `TestProfiles`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 523`** (2 nodes): `FIX 5(b): don't tie an obvious workstation; require role ports/DomainRole     fo`, `TestWorkstationVsServer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 524`** (1 nodes): `TestAcceptEchoReply`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 526`** (1 nodes): `TestMergeExclusions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 529`** (1 nodes): `TestDeviceEnrollment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 551`** (2 nodes): `Preferred scheme first, the other as a fallback: a scheme guess must         nev`, `WebScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 554`** (1 nodes): `TestNTLMRelayChecker`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 556`** (1 nodes): `TestVulnDB`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 557`** (1 nodes): `TestDeriveZones`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 558`** (2 nodes): `A socket whose connect() fails for `dead_family`, succeeds otherwise.`, `TestSmbNegotiateFallback`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 561`** (2 nodes): `Phase 1: combined scope validation (validate + excludes).`, `TestScopeValidationPipeline`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 562`** (2 nodes): `Phase 2: WebSocket message parsing.`, `TestWebSocketMessageProtocol`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 564`** (1 nodes): `test_main_scripts_device_ties.py — Phase 23: device classification never resolve`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 565`** (2 nodes): `test_nmap_xml_safety.py — nmap XML parsing must resist XML-bomb / entity injecti`, `TestNmapEntityGuard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 566`** (1 nodes): `test_probe_auto_enroll.py — trust-on-first-use enrollment gate + CIDR policy.  T`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 567`** (1 nodes): `TestClamp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 568`** (1 nodes): `TestEngagementModes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 572`** (1 nodes): `TestFetchEngagementScope`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 573`** (1 nodes): `TestValidateEnv`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 574`** (1 nodes): `TestParseHttpHead`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 575`** (1 nodes): `TestSMBEnumScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 576`** (1 nodes): `TestSMBLDAPFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 577`** (1 nodes): `TestOptionParsing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 578`** (1 nodes): `TestAssessTarpit`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 581`** (2 nodes): `Evasion: a fixed source port (e.g. 53/88) slips past naive stateless ACLs.`, `TestChooseSourcePort`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 590`** (2 nodes): `Callback`, `scanListeners`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 599`** (2 nodes): `_run_ad_assessment_and_save()`, `_set_job_status()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 609`** (2 nodes): `_claim_fixture()`, `TestAtomicWebSocketClaim`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 610`** (1 nodes): `TestTenantWebSocketSelection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 611`** (1 nodes): `TestGetAgentJobs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 612`** (1 nodes): `TestIngestParse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 613`** (1 nodes): `TestMirrorAge`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 614`** (1 nodes): `TestDNSFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 615`** (1 nodes): `TestDNSScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 617`** (1 nodes): `TestFTPFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 618`** (1 nodes): `TestFTPScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 619`** (1 nodes): `TestCheckHwBind`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 620`** (2 nodes): `Phase 1: result spool with upload retry.`, `TestResultSpoolWithRetry`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 622`** (1 nodes): `TestMSRPCScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 623`** (1 nodes): `test_nmap_wrapper.py — the "nmap returned 0 while native scanners saw ports" bug`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 624`** (1 nodes): `TestCliOnlineFlag`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 625`** (1 nodes): `TestIcmpParse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 626`** (1 nodes): `TestIcmpTimestamps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 627`** (1 nodes): `TestGate2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 629`** (1 nodes): `TestRsyncFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 630`** (1 nodes): `TestSMTPFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 631`** (1 nodes): `TestSSHFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 632`** (1 nodes): `TestVerifyReplyCookie`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 633`** (1 nodes): `TestPortScannerTarpitFlag`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 634`** (2 nodes): `The drift that used to exist: spec allows a port the gate refuses.`, `TestSingleSourceOfTruth`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 635`** (1 nodes): `Cross-validates the pure-Python Debian version comparator against the real `dpkg`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 636`** (1 nodes): `TestVNCFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 637`** (2 nodes): `Evasion: blur a fixed scan cadence with a bounded random per-probe delay.`, `TestJitteredDelay`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 652`** (1 nodes): `SSHCollector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 656`** (1 nodes): `TestIPMIFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 657`** (1 nodes): `TestIPMIScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 658`** (1 nodes): `TestMSRPCFindings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 659`** (1 nodes): `TestTimestampFallback`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 660`** (1 nodes): `TestPrinterScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 661`** (1 nodes): `TestGate3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 662`** (1 nodes): `TestGate4`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 663`** (1 nodes): `TestRouteBranches`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 664`** (1 nodes): `TestScanResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 667`** (1 nodes): `TestRsyncScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 668`** (1 nodes): `Product-boundary tests for the single-dashboard Manager API.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 669`** (1 nodes): `TestSMTPScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 671`** (1 nodes): `TestVNCScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 672`** (2 nodes): `Import-time probe constants built from user_agent() must be signature-free.`, `TestModuleConstantsUnbranded`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 675`** (1 nodes): `Initial schema — all tables  Revision ID: 0001 Revises: Create Date: 2026-05-19`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 676`** (1 nodes): `Allow the documented 0-1000 finding risk score range.  Revision ID: 0015 Revises`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 677`** (1 nodes): `Add is_active to users and tenants; add password_expires_at to users.  All exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 678`** (1 nodes): `Finding resolution lifecycle: coverage-gated auto-resolution columns.  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 679`** (1 nodes): `Finding verification verdict columns (P2 passive verification).  Revision ID: 00`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 680`** (1 nodes): `Approval-gated safe active-validation requests (P3).  Revision ID: 0022 Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 681`** (1 nodes): `Client portal slug — the customer's stable 'user as domain' handle.  Adds users.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 682`** (1 nodes): `Scan-request targets + intensity — the rich customer scan request.  Adds two nul`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 683`** (1 nodes): `Remediation plans — cached, OS-specific, structured remediation for a finding.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 684`** (1 nodes): `SLA policies — per-tenant custom remediation windows (hours per severity).  One`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 685`** (1 nodes): `Integrations — per-tenant notification config (email / Slack / Jira).  One row p`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 686`** (1 nodes): `scan_requests.use_case_id — the capability use-case a customer requested.  The p`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 729`** (1 nodes): `TestListAgents`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 730`** (1 nodes): `TestGetHwId`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 731`** (1 nodes): `TestAssetMergeCredentialed`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 732`** (1 nodes): `TestAssetMergeHostDiscovery`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 733`** (1 nodes): `TestAssetMergePortScan`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 734`** (1 nodes): `TestAssetOpenPortsForDeepScan`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 736`** (1 nodes): `TestKeyGeneration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 737`** (1 nodes): `TestRunnerScanTypes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 739`** (1 nodes): `TestProbePayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 740`** (1 nodes): `TestUserAgent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 741`** (2 nodes): `Collapse every trace for one rule into a single verdict + reason strings.     Pr`, `verdict_for_rule()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 742`** (2 nodes): `Engagement-level coverage roll-up over a set of traces. `rules_blind > 0`     is`, `summarize_traces()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 743`** (2 nodes): `Fires on EITHER of the rdp_scanner's two independent probes.      The scanner pr`, `_rdp_no_nla()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 744`** (2 nodes): `The server REFUSED a TLS-capable negotiation, so the session falls back to     l`, `_rdp_no_tls()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 745`** (2 nodes): `VNC type 2 is the legacy DES-based challenge with an 8-character password     ce`, `_vnc_weak_auth()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 754`** (1 nodes): `TestAssetMergePassiveCollect`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 755`** (1 nodes): `TestAssetMergeServiceBanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 756`** (1 nodes): `TestAssetMergeSmbScan`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 757`** (1 nodes): `TestAssetMergeTlsScan`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 758`** (1 nodes): `TestAssetMergeUnknownScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 759`** (1 nodes): `TestAssetMergeWebScan`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 761`** (1 nodes): `Fast port discovery with naabu. Feeds port list to Nmap.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 762`** (1 nodes): `Nmap service enumeration. Accepts port list from Naabu.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 763`** (1 nodes): `Nuclei vulnerability scan — production-ready.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 764`** (1 nodes): `Impacket-based AD enumeration: Kerberoast, AS-REP roast, LDAP anonymous bind.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 765`** (1 nodes): `NetExec SMB validation: signing, null sessions, SMBv1.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 766`** (1 nodes): `testssl.sh TLS/SSL analysis.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 767`** (1 nodes): `Extract HTTP/HTTPS URLs from nmap XML output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 768`** (1 nodes): `EyeWitness screenshot evidence collection.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 769`** (1 nodes): `Safe lateral movement checks — no actual exploitation.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 770`** (1 nodes): `Cloud infrastructure scan (AWS/Azure/GCP).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 771`** (1 nodes): `Read a KV-v2 secret from Vault.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 772`** (1 nodes): `Verify the Python probe can open what the TypeScript manager sealed (T14 interop`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 773`** (1 nodes): `Reference mock manager for end-to-end probe testing.  Implements the PROBE_PROTO`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 774`** (1 nodes): `Start the HTTPS server in a thread. Returns (httpd, base_url, pin_b64).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 775`** (1 nodes): `End-to-end probe test: real probe process ↔ reference mock manager over HTTPS.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 776`** (1 nodes): `Deterministic stand-ins emitting realistic output for 127.0.0.1.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 777`** (1 nodes): `Make a per-host scanner instance share ONE rate limiter + semaphore with all`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 778`** (1 nodes): `Make a raw banner safe and readable for the summary line.      Many services ans`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 779`** (1 nodes): `# NOTE: credentialed collectors (ssh_collector, windows_collector) are run`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 780`** (1 nodes): `ThreadingHTTPServer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `FindingSeverity` connect `Community 9` to `Community 82`, `Community 301`, `Community 201`, `Community 188`, `Community 226`, `Community 0`, `Community 73`, `Community 138`, `Community 262`, `Community 5`, `Community 374`, `Community 517`, `Community 472`, `Community 554`, `Community 3`, `Community 24`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Transport` connect `Community 113` to `Community 19`, `Community 250`, `Community 146`, `Community 139`, `Community 429`, `Community 251`, `Community 230`, `Community 332`, `Community 363`, `Community 430`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `FindingStatus` connect `Community 9` to `Community 82`, `Community 73`, `Community 5`, `Community 316`, `Community 201`, `Community 374`, `Community 262`, `Community 517`, `Community 226`, `Community 472`, `Community 554`, `Community 3`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.010318755745670812 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.02200737140110037 - nodes in this community are weakly interconnected._