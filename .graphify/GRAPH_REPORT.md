...
## Corpus Check
- Large corpus: 770 files · ~679,320 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 7417 nodes · 14952 edges · 417 communities detected
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 2776 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 3289 · uses: 2776 · calls: 2488 · method: 1824 · rationale_for: 1680 · MODIFIES: 1353 · imports: 478 · imports_from: 458 · ON_BRANCH: 310 · inherits: 214 · PARENT_OF: 82


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 770 · Candidates: 1726
- Excluded: 229 untracked · 64150 ignored · 6 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `6c1f014`
...
Cohesion: 0.02
Nodes (38): BloodHoundCollector — wrapper around the BloodHound.py collector + a Neo4j inges, NTLMRelayChecker — detect missing SMB/LDAP signing that enables NTLM relay.  NTL, HallucinationGuard — post-generation validation of LLM report text against the g, 298a9d4 trim frontend to 7 core pages; add use-case library, scope re-validation, result persistence, d1b4dd3 trim frontend to 7 core pages; add use-case library, scope re-validation, result persistence, RateLimiter — enforces PPS limits per CIDR and business-hour windows from the en, ServiceIdentifier — banner + port → structured service fingerprint. Handles: HTT, NucleiExploitRunner — CVE PoC validation using Nuclei templates.  Enforces templ (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (112): Shared building blocks for the Active Directory assessment module.  Every AD che, Assemble a Finding-compatible dict.      All findings carry — as required by the, Base class for Active Directory assessment errors., Raised when an LDAP/Kerberos/SMB connection to the DC fails., Raised when an optional offensive dependency (ldap3/impacket) is absent., engine_bridge.py — run the deterministic detection_engine on a probe's RAW FACTS, A previously-remediated finding whose issue reappeared this run: reopen     the, Background entry point (P1: keep detection OFF the probe-result request     path (+104 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (66): _env_number(), engine.py — adapt a manager scan job to scanner_module's workflow engine and ret, Read a bounded numeric safety setting without trusting the environment., Read a bounded numeric safety setting without trusting the environment., check_hw_bind(), get_hw_id(), HWBindError, hw_bind.py — hardware fingerprinting for binary host-locking.  The compiled bina (+58 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (99): agent.py — AgentDecisionEngine: the agentic AI advisor.  WHAT IT IS: a Claude to, LLMReportGenerator, LLMUnavailableError, LLMReportGenerator — Claude-backed narrative generation for VAPT reports.  Uses, Raised when the Anthropic SDK or API key is not configured., Agent, AgentStatus, Asset (+91 more)
...
Cohesion: 0.05
Nodes (48): ServiceFingerprint, AssetCriticality, UserRole, OrderedDict, Attack path analysis API (AttackPathService).  GET /engagements/{id}/attack-path, FindingImport, _finish_cancelled_nuclei_job(), _finish_failed_nuclei_job() (+40 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (44): get_read_db(), Read-only session (no commit) routed to the replica when configured.     For SEL, Read-only session (no commit) routed to the replica when configured.     For SEL, close_redis(), get_current_user(), Close the global Redis connection pool. Call during app shutdown., Reads user claims injected by TenantIsolationMiddleware.     Raises 401 if middl, Single source of truth for the deployed application version.  The value is injec (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (56): feat/coverage-gated-auto-resolution, integration/all-branches, main, 02b6341 feat(active-validation): pure escalation decision core, 045c9ae fix(posture): normalize run_at in _present_in_run; drop dead scores_prev call; tidy test import, 08e0594 deployement ready, 0b7bcb8 feat: probe bootstrap key — self-register without admin login, 0d6be85 feat(risk-rank): explainable 0-1000 finding priority (+48 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (61): bin(), binName(), collectProcess(), hasBinary(), hasSystemBinary(), httpBannerGrab(), HttpxLine, isWindows() (+53 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (47): ComplianceRef, COVERAGE_COLOR, DetectionCoverage, ExploitMaturity, Finding, FindingDetail(), FindingPage, FindingsPage() (+39 more)
...
Cohesion: 0.05
Nodes (34): _clean(), _Collector, Make a per-host scanner instance share ONE rate limiter + semaphore with all, Make a raw banner safe and readable for the summary line.      Many services ans, _rollup(), _run_active(), _shared(), main() (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (20): HallucinationGuard, Run all relevant checks and return a combined verdict:         ``{valid, issues,, Flag any CVE ID mentioned in ``text`` that isn't in the real finding set., Flag CVSS scores in the text that don't match any real score.          ``actual_, Flag destructive-looking commands that shouldn't appear in a fix guide., extract_features(), Fit an XGBoost regressor on historical findings. ``historical_findings_df``, Return a 0–1000 priority score. Uses the model if trained, else the formula. (+12 more)
...
Cohesion: 0.06
Nodes (19): _family_of(), PortScanner, port_scanner.py — TCP connect scan with an evidence-based state engine.  METHOD, Resolve a named scan profile to a concrete, de-duplicated port list.      'full', Per-target scan accounting — the completeness + self-health record.      It lets, Tally exactly one terminal per-port observation., Requested ports that were never recorded — the silent-skip proof., Ports recorded more than once (a port must get exactly one verdict). (+11 more)
...
Cohesion: 0.12
Nodes (35): task_runner.py — orchestrates the full lifecycle of a single scan job.  Given a, transport.py — all manager communication (HTTP + WebSocket) in one place.  Encap, use_cases.py — the finite, pre-defined library of scan scenarios the manager can, backup-before-secret-removal, feat/probe-usecase-alignment, spike/probe-go, worktree-fleet-already-downloaded-cmd, 01f4398 feat(probe): IoT survey reaches the banner stage (service_fingerprint) (+27 more)
...
Cohesion: 0.10
Nodes (28): _ber_len(), _ber_parse(), _build_get(), _build_getbulk_v2c(), _build_getnext(), _decode_oid(), _decode_value(), _encode_oid() (+20 more)
...
Cohesion: 0.08
Nodes (33): _finalize_trace(), _gather_per_host(), _port_candidates(), workflow_engine.py — the async DAG executor. Loops through gates, checks precond, In-memory ResultWriter stand-in — PassiveCollector/SSHCollector/     WindowsColl, Return TCP ports worth scanning for this profile and requested branch set., Return TCP ports worth scanning for this profile and requested branch set., Return TCP ports worth scanning for this profile and requested branch set. (+25 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (26): ApiActivity, GET, GET, POST, Exposure, GET, INTENSITY_PRESETS, LaunchBody (+18 more)
...
Cohesion: 0.12
Nodes (21): ADConnectionError, ADError, build_ad_finding(), DependencyMissingError, severity_from_str(), ADComputer, ADGroup, ADUser (+13 more)
...
Cohesion: 0.07
Nodes (8): test_syn_scanner.py — stateless SYN scan (Tier 1.1).  The raw-socket send/receiv, TestCapabilityDetection, TestChecksum, TestClassify, TestPacketRoundTrip, TestSynCookie, TestSynScannerFallback, TestVerifyReplyCookie
...
Cohesion: 0.09
Nodes (22): BaseModel, ActivityItem, AgentBootstrapRequest, AssetIn, AssetOut, BulkAssetImportResult, LoginRequest, PersonalAccessTokenCreate (+14 more)
...
Cohesion: 0.13
Nodes (21): Base, AttackTimeline, DetectionConfig, DetectionResult, AgentCredential, ProbeEnrollmentRequest, ProbeEnrollmentToken, Pre-authorized, Site-bound enrollment token.      Lets a probe auto-enroll (no o (+13 more)
...
Cohesion: 0.09
Nodes (16): classify_os_error(), _family_of(), PortScanner, Map a connect()-time OSError to (state, reason).      DNS failures (socket.gaier, Return 'ipv4'/'ipv6' for an IP literal, else None (unresolved hostname)., Map a connect()-time OSError to (state, reason).      DNS failures (socket.gaier, Per-target scan accounting — the completeness + self-health record.      It lets, Tally exactly one terminal per-port observation. (+8 more)

### Community 69 - "Community 69"
Cohesion: 0.14
Nodes (17): AiMessage, ManagerAiResponse, POST(), validMessages(), ManagerAiResponse, cveRecordToFactCard(), detectFindingId(), FactCardVM (+9 more)
...
Cohesion: 0.09
Nodes (16): 9a36729 feat(resolution): coverage builder from completed-scanner facts, cbf5d6c feat(resolution): pure decision core (coverage + confirm window + db guard), apply_manual_reopen(), build_coverage(), decide_resolution(), evaluate_resolutions(), host_of(), resolution.py — coverage-gated auto-resolution of findings.  Split into a PURE c (+8 more)
...
Cohesion: 0.13
Nodes (22): GET, POST, ApiActivity, fail(), GET, PUT(), DETECTION_TO_UI, ENG_STATUS_TO_API (+14 more)
...
Cohesion: 0.11
Nodes (20): build_ip_header(), build_syn_packet(), build_tcp_syn(), classify(), _local_source_ip(), parse_packet(), syn_scanner.py — stateless TCP SYN (half-open) scan, pure Python (Tier 1.1).  WH, Parse a raw IPv4+TCP packet (as received on a raw IPPROTO_TCP socket). (+12 more)
...
Cohesion: 0.14
Nodes (12): MetasploitRPCClient, MetasploitRPCError, MetasploitRPCClient — async client for msfrpcd.  Protocol: MessagePack RPC over, Returns {status, output, uuid}., Returns True if job was successfully killed., Poll until job completes or max_wait exceeded., Authenticated RPC call — prepends token., Async Metasploit RPC client using msgpack-over-HTTPS. (+4 more)
...
Cohesion: 0.14
Nodes (12): ManagerAiResponse, BASE, BackendError, BackendOpts, BASE, bearerFrom(), cookieFrom(), fail() (+4 more)
...
Cohesion: 0.11
Nodes (12): AdvisorFlow(), PATCH_PILL, AssistantDrawer(), ExplainResponse, Msg, Served, FactCard(), AiStatus (+4 more)
...
Cohesion: 0.12
Nodes (14): BaseScanner, main_entrypoint(), One observation about one target. Pure fact, no interpretation.      Network-sta, Subclasses implement `scan_target(self, target)` (async), returning a list     o, One observation about one target. Pure fact, no interpretation., One observation about one target. Pure fact, no interpretation., Run a scanner CLI's body with consistent, operator-friendly error handling., Subclasses implement `scan_target(self, target)` (async), returning a list     o (+6 more)
...
Cohesion: 0.11
Nodes (15): GzipRequestMiddleware, Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard., Identify the Manager API without exposing a second dashboard., _service_root(), agent_jwt_path_allows(), _is_public_enrollment_request() (+7 more)

### Community 125 - "Community 125"
Cohesion: 0.18
Nodes (17): DeclarativeBase, agent_recommendation.py — decisions/actions proposed by the agentic AI advisor., Append-only ledger of every attack action performed during an engagement.      W, Immutable, append-only audit trail for all exploit actions.     No TimestampMixi, Base, TimestampMixin, UUIDMixin, Per-engagement SIEM + EDR connection settings used by the detection     validati (+9 more)
...
Cohesion: 0.12
Nodes (12): async_udp_probe(), async_udp_probe_retry(), expand_targets(), Accepts CIDRs ('10.0.0.0/24'), single IPs, hostnames, and simple ranges     ('10, One-shot datagram protocol backing `async_udp_probe`. Resolves its future     wi, Send one UDP datagram and await the first reply — fully on the event loop., `async_udp_probe` with bounded per-port retransmit.      Returns on the FIRST de, Writes ScanResult objects as JSONL to a file and/or stdout. (+4 more)
...
Cohesion: 0.17
Nodes (10): AiGenerateRequest, AiGenerateResponse, AiMessage, AiProviderStatus, AiStatusResponse, AiRuntimeError, _is_local_ollama_model(), Ordered runtimes to try: requested/default first, then the OpenRouter         fr (+2 more)
...
Cohesion: 0.13
Nodes (13): bracket_host(), classify_os_error(), describe_os_error(), inet_checksum(), parse_ports(), scanner_base.py — shared foundation for every scanner module.  SCOPE OF THIS MOD, Full, debuggable classification for attaching to a ScanResult: state,     reason, Standard 16-bit one's-complement Internet checksum (RFC 1071), used for IP, (+5 more)
...
Cohesion: 0.18
Nodes (8): bulk_import_assets(), _compute_overview(), create_engagement(), engagements_overview(), EngagementUpdate, _overview_cache_key(), _refresh_overview_cache(), update_engagement()
...
Cohesion: 0.14
Nodes (5): result_spool.py — local result persistence with upload retry.  When the probe co, Tests for agent/result_spool.py, ResultSpool with tiny retry delay for fast tests., ResultSpool with tiny retry delay for fast tests., spool()
...
Cohesion: 0.22
Nodes (13): create_findings_from_probe_result(), create_scan_health_finding(), _escalate_by_exposure(), _find_open_duplicate(), _finding_port(), _map_severity(), A still-relevant Finding with the same (engagement, asset, title), if any., Convert a probe's self-assessed `findings` list into persisted Finding rows. (+5 more)
...
Cohesion: 0.35
Nodes (3): ManagerLlmService, Call one provider and normalize failures to AiRuntimeError.         Preserves th, Try each candidate until one succeeds. On ANY provider failure (credit         e
...
Cohesion: 0.20
Nodes (6): AdaptiveRateController, A self-tuning concurrency window, modelled on TCP congestion control (AIMD),, Current integer window (>= min_window)., Current integer window (>= min_window)., A self-tuning concurrency window, modelled on TCP congestion control (AIMD),, Current integer window (>= min_window).
...
Cohesion: 0.18
Nodes (11): expand_targets(), A self-tuning concurrency window, modelled on TCP congestion control (AIMD),, Accepts CIDRs ('10.0.0.0/24'), single IPs, hostnames, and simple ranges     ('10, Accepts CIDRs ('10.0.0.0/24'), single IPs, hostnames, and simple ranges     ('10, Accepts CIDRs ('10.0.0.0/24'), single IPs, hostnames, and simple ranges     ('10, Wire argparse args into a scanner instance and execute it., Wire argparse args into a scanner instance and execute it., Wire argparse args into a scanner instance and execute it. (+3 more)
...
Cohesion: 0.20
Nodes (9): async_udp_probe(), async_udp_probe_retry(), Send one UDP datagram and await the first reply — fully on the event loop., Send one UDP datagram and await the first reply — fully on the event loop., Send one UDP datagram and await the first reply — fully on the event loop., `async_udp_probe` with bounded per-port retransmit.      Returns on the FIRST de, `async_udp_probe` with bounded per-port retransmit.      Returns on the FIRST de, Send one UDP datagram and await the first reply — fully on the event loop. (+1 more)
...
Cohesion: 0.31
Nodes (6): get_finding(), patch_finding(), Operator reverses a resolution (auto or manual). Only a `remediated`     finding, Operator reverses a resolution (auto or manual). Only a `remediated`     finding, reopen_finding(), _tenant_finding()
...
Cohesion: 0.54
Nodes (8): agents/greeting-introduction, main, 0510df3 going to build prompt and connection, architecture almost done, 0557559 scanner: real use-case library, probe-to-manager flow, rebuilt Scanner UI, 8d65c92 first commit, a388bb3 script updated, architecture design and integration with adversa repo, bd7383f scanner fine ..now integrations, f5ce592 first commit

### Community 274 - "Community 274"
Cohesion: 0.25
Nodes (5): GET, STATUS_TO_API, VALID_SEVERITIES, VALID_SORTS, VALID_VERIFICATION
...
Cohesion: 0.29
Nodes (4): AgentConnectionManager, Tracks WebSocket connections from probes/agents for direct job push.      Each c, Register an agent's WebSocket connection.          If the agent already has a co, Register an agent's WebSocket connection.          If the agent already has a co
...
Cohesion: 0.47
Nodes (4): AssistantFab(), AssistantCtx, Ctx, useAssistant()
...
Cohesion: 0.33
Nodes (5): PassiveListenerError, All passive sources failed before the listen window could start., RuntimeError, Raised when a required configuration invariant is violated at boot., StartupValidationError
...
Cohesion: 0.33
Nodes (6): bracket_host(), Wrap an IPv6 literal in [] for a URL authority; leave v4/hostnames as-is.     'h, Wrap an IPv6 literal in [] for a URL authority; leave v4/hostnames as-is.     'h, Wrap an IPv6 literal in [] for a URL authority; leave v4/hostnames as-is.     'h, Wrap an IPv6 literal in [] for a URL authority; leave v4/hostnames as-is.     'h, Wrap an IPv6 literal in [] for a URL authority; leave v4/hostnames as-is.     'h
...
Cohesion: 0.50
Nodes (4): bootstrap_agent(), Allows a probe to register without an admin-issued PAT.      The manager must ha, Allows a probe to register without an admin-issued PAT.      The manager must ha, Allows a probe to register without an admin-issued PAT.      The manager must ha
...
Cohesion: 0.67
Nodes (2): Record transport features explicitly advertised by a connected probe., Record transport features explicitly advertised by a connected probe.
...
## Knowledge Gaps
- **1784 isolated node(s):** `Initial schema — all tables  Revision ID: 0001 Revises: Create Date: 2026-05-19`, `Add services and agents tables  Revision ID: 0002 Revises: 0001 Create Date: 202`, `Add enrichment fields index + webhook column to engagements  Revision ID: 0003 R`, `Exploit results, approvals, and audit log tables  Revision ID: 0004 Revises: 000`, `Detection validation: attack_timeline, detection_configs, extend detection_resul` (+1779 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 84`** (2 nodes): `_ExplodingScanner`, `test_per_target_exception_preserves_other_results()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `TestResultSpool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `TestUDPProbeConstruction`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (1 nodes): `TestServiceIdentifier`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (1 nodes): `TestSNMPBerUtilities`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (1 nodes): `Use-case library guards.  FORBIDDEN is a *living* set: a phrase stays here only`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (2 nodes): `_action()`, `TestDetectionCorrelator`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 196`** (1 nodes): `TestMobileScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 197`** (1 nodes): `TestValidateTargetsInScope`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 205`** (2 nodes): `_make_scan_record()`, `TestDeltaEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (1 nodes): `TestScopeGuard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (1 nodes): `TestAgentJobCompatibility`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 221`** (1 nodes): `TestPathAnalyzer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 224`** (2 nodes): `Tests that use the real engine but with no-op callbacks.`, `TestRunnerHeadless`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 230`** (1 nodes): `TestADCSChecker`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (1 nodes): `TestVersionInRanges`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 233`** (1 nodes): `TestNucleiExploitRunner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 234`** (1 nodes): `TestValidatePayload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (1 nodes): `TestExpandTargets`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 237`** (2 nodes): `test_enroll_token_usable_only_while_live_unrevoked_and_under_max_uses()`, `_token()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 238`** (1 nodes): `TestNmapXMLParser`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 249`** (1 nodes): `TestGraphBuilder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 251`** (1 nodes): `TestClassifyDevice`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 253`** (1 nodes): `TestIoTScanner`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 254`** (1 nodes): `TestParsePorts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 255`** (2 nodes): `Each encryption uses a fresh ephemeral key, so blobs are different.`, `TestEncryptDecryptRoundtrip`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 257`** (1 nodes): `TestSubmitResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 267`** (1 nodes): `TestUseCasesResolve`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 269`** (1 nodes): `TestTargetsInExcludes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 270`** (1 nodes): `TestIdentity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (2 nodes): `ssh_collector.py — credentialed (authenticated) inventory collection for Linux.`, `SSHCollector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 283`** (2 nodes): `ssh_collector.py — credentialed (authenticated) inventory collection for Linux.`, `SSHCollector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `TestKerberoastChecker`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `TestMetasploitRPCClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `TestRequiresApproval`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `test_main_scripts_statemodel.py — Phase 1: the normalized ScanResult state model`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (2 nodes): `test_new_scanners.py — unit tests for the five new/enhanced scanner modules.  Te`, `TestVersionChange`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `TestTuningFromParams`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 303`** (1 nodes): `TestBloodHoundCollector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 304`** (1 nodes): `TestNeo4jClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 305`** (1 nodes): `TestDeceptionScore`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 306`** (1 nodes): `TestIngestFile`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 307`** (1 nodes): `TestSigmaRuleGenerator`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 308`** (1 nodes): `TestValidateModule`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 309`** (1 nodes): `TestValidateScope`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 311`** (1 nodes): `TestNormalizeMac`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 313`** (1 nodes): `TestMergeExclusions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 327`** (1 nodes): `TestNTLMRelayChecker`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 328`** (2 nodes): `_claim_fixture()`, `TestAtomicWebSocketClaim`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 330`** (1 nodes): `TestCvss`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 331`** (1 nodes): `TestIngestValidation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 332`** (1 nodes): `TestSIEMParsing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 336`** (1 nodes): `TestStableHostId`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 337`** (1 nodes): `TestClamp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 338`** (1 nodes): `TestEngagementModes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 340`** (1 nodes): `TestFetchEngagementScope`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 358`** (1 nodes): `TestTenantWebSocketSelection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 359`** (1 nodes): `TestGetAgentJobs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 360`** (1 nodes): `TestGraphVisualizer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 362`** (1 nodes): `TestCheckHwBind`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 363`** (1 nodes): `TestEngineSummary`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 364`** (1 nodes): `TestLooksLikeHttp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 365`** (1 nodes): `TestLooksLikeTls`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 366`** (1 nodes): `TestResolveScanType`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 367`** (1 nodes): `TestTargets`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 368`** (2 nodes): `_scope()`, `TestBuildDefaultFunnel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 369`** (1 nodes): `TestRoutePorts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 370`** (1 nodes): `TestDeviceEnrollment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 371`** (1 nodes): `TestWebSocket`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 378`** (1 nodes): `TestGate0`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 379`** (1 nodes): `TestRateLimiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 380`** (1 nodes): `TestScanResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 382`** (1 nodes): `TestHeartbeat`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 383`** (1 nodes): `TestHttpGet`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 384`** (1 nodes): `TestPollJobs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 385`** (1 nodes): `TestRefreshRegistration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 386`** (1 nodes): `TestRegister`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 389`** (2 nodes): `_ConcurrencyScanner`, `test_host_fanout_is_bounded()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 390`** (1 nodes): `Allow the documented 0-1000 finding risk score range.  Revision ID: 0015 Revises`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 391`** (1 nodes): `Add is_active to users and tenants; add password_expires_at to users.  All exist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 392`** (1 nodes): `Finding resolution lifecycle: coverage-gated auto-resolution columns.  Revision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 393`** (1 nodes): `Finding verification verdict columns (P2 passive verification).  Revision ID: 00`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 394`** (1 nodes): `Approval-gated safe active-validation requests (P3).  Revision ID: 0022 Revises:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 401`** (2 nodes): `_priority()`, `Assets that appear in more than ``threshold`` (default 50%) of all paths —`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 403`** (1 nodes): `risk_rank.py — one explainable 0-1000 priority for a finding.  Blends impact (se`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 404`** (1 nodes): `TestAgentWebSocketAuthentication`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 405`** (1 nodes): `TestJobSecretBoundary`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 407`** (2 nodes): `Record transport features explicitly advertised by a connected probe.`, `Record transport features explicitly advertised by a connected probe.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 408`** (2 nodes): `Record a heartbeat from an agent.`, `Record a heartbeat from an agent.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 409`** (2 nodes): `Dispatch a real ScanResult into the right sub-structure, keyed         on result`, `Dispatch a real ScanResult into the right sub-structure, keyed         on result`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 410`** (1 nodes): `Fast port discovery with naabu. Feeds port list to Nmap.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 411`** (1 nodes): `Nmap service enumeration. Accepts port list from Naabu.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 412`** (1 nodes): `Nuclei vulnerability scan — production-ready.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 413`** (1 nodes): `Impacket-based AD enumeration: Kerberoast, AS-REP roast, LDAP anonymous bind.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 414`** (1 nodes): `NetExec SMB validation: signing, null sessions, SMBv1.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 415`** (1 nodes): `testssl.sh TLS/SSL analysis.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 416`** (1 nodes): `Extract HTTP/HTTPS URLs from nmap XML output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 417`** (1 nodes): `EyeWitness screenshot evidence collection.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 418`** (1 nodes): `Safe lateral movement checks — no actual exploitation.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 419`** (1 nodes): `Cloud infrastructure scan (AWS/Azure/GCP).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 420`** (1 nodes): `Fetches credentials from HashiCorp Vault at runtime. Never caches to disk.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 421`** (1 nodes): `Read a KV-v2 secret from Vault.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 422`** (1 nodes): `Verify the Python probe can open what the TypeScript manager sealed (T14 interop`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 423`** (1 nodes): `Reference mock manager for end-to-end probe testing.  Implements the PROBE_PROTO`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 424`** (1 nodes): `Start the HTTPS server in a thread. Returns (httpd, base_url, pin_b64).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 425`** (1 nodes): `End-to-end probe test: real probe process ↔ reference mock manager over HTTPS.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 426`** (1 nodes): `Deterministic stand-ins emitting realistic output for 127.0.0.1.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 427`** (1 nodes): `ThreadingHTTPServer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `FindingSeverity` connect `Community 1` to `Community 5`, `Community 101`, `Community 123`, `Community 145`, `Community 0`, `Community 47`, `Community 96`, `Community 163`, `Community 183`, `Community 159`, `Community 219`, `Community 230`, `Community 303`, `Community 286`, `Community 327`, `Community 92`, `Community 135`, `Community 193`, `Community 288`, `Community 233`, `Community 289`, `Community 308`, `Community 234`, `Community 309`, `Community 60`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Transport` connect `Community 240` to `Community 24`, `Community 166`, `Community 200`, `Community 318`, `Community 353`, `Community 261`, `Community 348`, `Community 351`, `Community 347`, `Community 349`, `Community 350`, `Community 352`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `AgentConnectionManager` connect `Community 316` to `Community 2`, `Community 395`, `Community 396`, `Community 259`, `Community 397`, `Community 398`, `Community 399`, `Community 315`, `Community 407`, `Community 408`, `Community 404`, `Community 328`, `Community 405`, `Community 358`, `Community 3`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.023135642982971227 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.04810531496062992 - nodes in this community are weakly interconnected._