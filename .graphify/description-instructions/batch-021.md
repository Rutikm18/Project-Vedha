...
- "services_llm": "llm.py" | kind=code-symbol | source=manager/backend/app/services/llm.py:L1 | neighbors=[1fe16c8 stable but some dead code, need…, config.py, AiRuntimeError, _is_local_ollama_model(), ManagerLlmService, Runtime]
