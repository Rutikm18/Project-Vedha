# Node Description Batch 56 of 336
...
- "lib_adapters_toapiengagementpatch": "toApiEngagementPatch()" | kind=code-symbol | source=manager/frontend/lib/adapters.ts:L249 | neighbors=[route.ts, adapters.ts, engStatusToApi(), normalizeList(), engagement-adapters.test.ts] | lang=en
- "lib_ai_engine_stripfences": "stripFences()" | kind=code-symbol | source=manager/frontend/lib/ai-engine.ts:L444 | neighbors=[ai-engine.ts, generateReportSingleCall(), runSection(), triageFindings(), generateReport()] | lang=en
- "lib_assistant_cverecordtofactcard": "cveRecordToFactCard()" | kind=code-symbol | source=manager/frontend/lib/assistant.ts:L186 | neighbors=[assistant.ts, preferredText(), publicSeverity(), security-context.ts, assistant.test.ts] | lang=en
- "lib_assistant_detectfindingid": "detectFindingId()" | kind=code-symbol | source=manager/frontend/lib/assistant.ts:L81 | neighbors=[AssistantDrawer.tsx, route.ts, assistant.ts, security-context.ts, assistant.test.ts] | lang=en
...
- "lib_campaign_store_listcampaigns": "listCampaigns()" | kind=code-symbol | source=manager/frontend/lib/campaign-store.ts:L165 | neighbors=[route.ts, campaign-store.ts, ensureDir(), getCampaign(), campaign-store.test.ts] | lang=en
- "lib_campaign_store_validatesnapshot": "validateSnapshot()" | kind=code-symbol | source=manager/frontend/lib/campaign-store.ts:L100 | neighbors=[campaign-store.ts, getCampaign(), saveCampaign(), isSafeCampaignId(), campaign-store.test.ts] | lang=en
