# Node Description Batch 56 of 134
...
- "app_config_get_settings": "get_settings()" | kind=code-symbol | source=manager/backend/app/config.py:L123 | neighbors=[config.py, Settings]
