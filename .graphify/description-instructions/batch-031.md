...
- "routers_ai": "ai.py" | kind=code-symbol | source=manager/backend/app/routers/ai.py:L1 | neighbors=[1fe16c8 stable but some dead code, need…, dependencies.py, ai_generate(), ai_status()]
