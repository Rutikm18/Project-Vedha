# Node Description Batch 59 of 144
...
- "app_config_get_settings": "get_settings()" | kind=code-symbol | source=manager/backend/app/config.py:L126 | neighbors=[config.py, Settings]
