# Node Description Batch 121 of 209
...
- "app_main_gziprequestmiddleware_call": ".__call__()" | kind=code-symbol | source=manager/backend/app/main.py:L122 | neighbors=[GzipRequestMiddleware]
- "app_main_gziprequestmiddleware_init": ".__init__()" | kind=code-symbol | source=manager/backend/app/main.py:L119 | neighbors=[GzipRequestMiddleware]
- "app_main_lifespan": "lifespan()" | kind=code-symbol | source=manager/backend/app/main.py:L71 | neighbors=[main.py]
