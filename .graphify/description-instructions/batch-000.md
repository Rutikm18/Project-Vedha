# Node Description Batch 1 of 209
...
- "findings_page": "page.tsx" | kind=code-symbol | source=manager/frontend/app/portal/findings/page.tsx:L1 | neighbors=[1fe16c8 stable but some dead code, need…, 22701ea Add tests for scanner parity an…, 41b692a Update project files, 8ebc053 feat(risk-rank-ui): surface ver…, b4b12a9 Rename project and update files, c52feb4 feat(portal): reskin User Porta…]
...
- "commit:repo:github.com/Rutikm18/Project-Vedha@4d0377d8515df5e6d968b7b06a2da2dae5654fbf": "4d0377d Add unit tests for SMB scanner, SYN scanner, and TLS functionality- Imp…" | kind=Commit | source=git | neighbors=[feat/coverage-gated-auto-resolution, feat/syn-scanner-osfp-adaptive, integration/all-branches, main, 6c1f014 feat(correlation): implement co…, enrichment_db.py]
...
- "reports_page": "page.tsx" | kind=code-symbol | source=manager/frontend/app/reports/page.tsx:L1 | neighbors=[10dfc80 Add comprehensive probe testing…, 1fe16c8 stable but some dead code, need…, 22701ea Add tests for scanner parity an…, c52feb4 feat(portal): reskin User Porta…, d1b4dd3 trim frontend to 7 core pages; …, f00ce5f fix(ui): session-timer persiste…]
