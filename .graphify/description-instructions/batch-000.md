# Node Description Batch 1 of 186
...
- "commit:repo:github.com/Rutikm18/Project-Vedha@4d0377d8515df5e6d968b7b06a2da2dae5654fbf": "4d0377d Add unit tests for SMB scanner, SYN scanner, and TLS functionality- Imp…" | kind=Commit | source=git | neighbors=[feat/coverage-gated-auto-resolution, integration/all-branches, 6c1f014 feat(correlation): implement co…, enrichment_db.py, version_compare.py, vuln_db.py]
- "findings_page": "page.tsx" | kind=code-symbol | source=manager/frontend/app/findings/page.tsx:L1 | neighbors=[1fe16c8 stable but some dead code, need…, 41b692a Update project files, 8ebc053 feat(risk-rank-ui): surface ver…, b4b12a9 Rename project and update files, d1b4dd3 trim frontend to 7 core pages; …, AssistantProvider.tsx]
