# Node Description Batch 42 of 186
...
- "app_main_gziprequestmiddleware": "GzipRequestMiddleware" | kind=code-symbol | source=manager/backend/app/main.py:L114 | neighbors=[main.py, .__call__(), .__init__(), TenantIsolationMiddleware] | lang=en
...
- "commit:repo:github.com/Rutikm18/Project-Vedha@6a1c958273a695fdfb8a8e43254742b6436b3b8e": "6a1c958 docs(plans): record execution status for active-validation + risk-rank …" | kind=Commit | source=git | neighbors=[50d6554 feat(active-validation): approv…, feat/coverage-gated-auto-resolution, integration/all-branches, 8ebc053 feat(risk-rank-ui): surface ver…] | lang=en
...
- "components_sidebar_sidebar": "Sidebar()" | kind=code-symbol | source=manager/frontend/components/Sidebar.tsx:L52 | neighbors=[PageShell.tsx, Sidebar.tsx, page.tsx, page.tsx] | lang=en
