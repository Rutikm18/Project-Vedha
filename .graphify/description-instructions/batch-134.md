# Node Description Batch 135 of 336
...
- "main_scripts_port_scanner_portscanner_build": "._build()" | kind=code-symbol | source=probe/main_scripts/port_scanner.py:L427 | neighbors=[PortScanner, ._attempt()]
