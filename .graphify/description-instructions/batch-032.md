# Node Description Batch 33 of 131
...
- "detection_engine_verifier_rationale_96": "Calibrate and stamp a Finding. Mutates and returns it.      reachability: \"open\"" | kind=entity | source=manager/detection_engine/verifier.py:L96 | neighbors=[verify(), Finding, FindingState, SourceConfidence]
- "detection_engine_version_compare_dpkg_compare": "dpkg_compare()" | kind=code-symbol | source=manager/detection_engine/version_compare.py:L166 | neighbors=[version_compare.py, _dpkg_compare_pure_python(), _dpkg_compare_via_binary(), -1 if a<b, 0 if a==b, 1 if a>b, per Deb…]
