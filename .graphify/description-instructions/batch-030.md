...
- "hooks_usemousegradient": "useMouseGradient.ts" | kind=code-symbol | source=manager/frontend/hooks/useMouseGradient.ts:L1 | neighbors=[page.tsx, d1b4dd3 trim frontend to 7 core pages; …, useMouseGradient(), 298a9d4 trim frontend to 7 core pages; …] | lang=en
