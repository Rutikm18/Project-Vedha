# Node Description Batch 81 of 104
...
- "pipeline_fact": "Fact" | kind=code-symbol | source=probe-go/pipeline/pipeline.go:L41 | neighbors=[pipeline.go]
- "pipeline_job": "Job" | kind=code-symbol | source=probe-go/pipeline/pipeline.go:L25 | neighbors=[pipeline.go]
- "pipeline_result": "Result" | kind=code-symbol | source=probe-go/pipeline/pipeline.go:L44 | neighbors=[pipeline.go]
...
to: /Users/rutikmangale/Documents/DRIVE T -Var/Security-projects/Agentic VA Scanner/.graphify/description-instructions/batch-080.json
