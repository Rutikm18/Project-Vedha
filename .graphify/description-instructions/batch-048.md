# Node Description Batch 49 of 76
...
- "aibrain_page_message": "Message" | kind=code-symbol | source=manager/frontend/app/aibrain/page.tsx:L8 | neighbors=[page.tsx] | lang=en
...
- "app_config_settings_cors_origins": ".cors_origins()" | kind=code-symbol | source=manager/backend/app/config.py:L77 | neighbors=[Settings] | lang=en
