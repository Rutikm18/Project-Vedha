# Node Description Batch 6 of 186
...
- "commit:repo:github.com/Rutikm18/Project-Vedha@81c81cbb1d1a039f73bc699431d61b9dd84648fe": "81c81cb feat: implement outbox reclaim tests and add enrollment token functiona…" | kind=Commit | source=git | neighbors=[agent.py, feat/coverage-gated-auto-resolution, integration/all-branches, main, worktree-fleet-already-downloaded-cmd, 30261eb feat: enhance advisor flow with…]
...
- "main_scripts_tls_fingerprint": "tls_fingerprint.py" | kind=code-symbol | source=probe/main_scripts/tls_fingerprint.py:L1 | neighbors=[4d0377d Add unit tests for SMB scanner,…, build_client_hello(), cipher_code(), _ext(), fingerprint_host(), jarm_style_digest()]
...
- "scanner_tls_fingerprint": "tls_fingerprint.py" | kind=code-symbol | source=probe/scanner/tls_fingerprint.py:L1 | neighbors=[4d0377d Add unit tests for SMB scanner,…, build_client_hello(), cipher_code(), _ext(), fingerprint_host(), jarm_style_digest()]
...
- "tests_test_async_udp": "test_async_udp.py" | kind=code-symbol | source=probe/tests/test_async_udp.py:L1 | neighbors=[4d0377d Add unit tests for SMB scanner,…, scanner_base.py, _EchoProtocol, _SinkProtocol, _start_server(), test_datagram_received_resolves_future_…]
