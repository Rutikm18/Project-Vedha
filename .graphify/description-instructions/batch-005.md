# Node Description Batch 6 of 76
...
- "tests_test_exploit_engine": "test_exploit_engine.py" | kind=code-symbol | source=manager/backend/tests/test_exploit_engine.py:L1 | neighbors=[298a9d4 trim frontend to 7 core pages; …, _engagement(), _finding(), pytest_addoption(), TestExploitOrchestrator, TestMetasploitIntegration]
...
- "lib_auth_store": "auth-store.ts" | kind=code-symbol | source=manager/frontend/lib/auth-store.ts:L1 | neighbors=[298a9d4 trim frontend to 7 core pages; …, auth-middleware.ts, generateOtp(), OtpEntry, otpStore, OtpVerifyResult]
- "lib_backend_backend": "backend()" | kind=code-symbol | source=manager/frontend/lib/backend.ts:L29 | neighbors=[route.ts, route.ts, route.ts, route.ts, route.ts, backend.ts]
...
- "models_attack_path_attackpath": "AttackPath" | kind=code-symbol | source=manager/backend/app/models/attack_path.py:L11 | neighbors=[attack_path.py, Base, Base, TimestampMixin, TimestampMixin, GenerateRequest]
...
- "routers_agents_agentregisterrequest": "AgentRegisterRequest" | kind=code-symbol | source=manager/backend/app/routers/agents.py:L63 | neighbors=[agents.py, BaseModel, Agent, AgentStatus, Asset, Engagement]
- "routers_agents_enqueuejobrequest": "EnqueueJobRequest" | kind=code-symbol | source=manager/backend/app/routers/agents.py:L88 | neighbors=[agents.py, BaseModel, Agent, AgentStatus, Asset, Engagement]
- "routers_agents_heartbeatrequest": "HeartbeatRequest" | kind=code-symbol | source=manager/backend/app/routers/agents.py:L76 | neighbors=[agents.py, BaseModel, Agent, AgentStatus, Asset, Engagement]
- "routers_agents_jobresultrequest": "JobResultRequest" | kind=code-symbol | source=manager/backend/app/routers/agents.py:L82 | neighbors=[agents.py, BaseModel, Agent, AgentStatus, Asset, Engagement]
