# Node Description Batch 54 of 236
...
- "lib_portal_client_severity_var": "SEVERITY_VAR" | kind=code-symbol | source=manager/frontend/lib/portal-client.ts:L116 | neighbors=[page.tsx, portal-client.ts, page.tsx, page.tsx]
...
- "main_scripts_findings_corr_anon_data_exposure": "_corr_anon_data_exposure()" | kind=code-symbol | source=probe/main_scripts/findings.py:L1056 | neighbors=[findings.py, _by_target(), Finding, Two or more INDEPENDENT anonymous data-…]
- "main_scripts_findings_corr_mgmt_plane_exposed": "_corr_mgmt_plane_exposed()" | kind=code-symbol | source=probe/main_scripts/findings.py:L1098 | neighbors=[findings.py, _by_target(), Finding, Out-of-band / console management surfac…]
- "main_scripts_findings_corr_user_enum_plus_weak_auth": "_corr_user_enum_plus_weak_auth()" | kind=code-symbol | source=probe/main_scripts/findings.py:L1075 | neighbors=[findings.py, _by_target(), Finding, A disclosed user list (SMB null session…]
