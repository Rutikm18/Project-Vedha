# Node Description Batch 12 of 209
...
- "portal_portalshell": "PortalShell.tsx" | kind=code-symbol | source=manager/frontend/components/portal/PortalShell.tsx:L1 | neighbors=[c52feb4 feat(portal): reskin User Porta…, page.tsx, page.tsx, ThemeProvider.tsx, useTheme(), FooterClock()]
...
- "scanner_service_banner": "service_banner.py" | kind=code-symbol | source=probe/scanner/service_banner.py:L1 | neighbors=[10dfc80 Add comprehensive probe testing…, 22701ea Add tests for scanner parity an…, 4d0377d Add unit tests for SMB scanner,…, d1b4dd3 trim frontend to 7 core pages; …, _dec(), main()]
...
- "scanner_web_scanner": "web_scanner.py" | kind=code-symbol | source=probe/scanner/web_scanner.py:L1 | neighbors=[10dfc80 Add comprehensive probe testing…, bce780a feat(probe): enumerate HTTP met…, d1b4dd3 trim frontend to 7 core pages; …, _fetch(), main(), _NoRedirect]
...
- "commit:repo:github.com/Rutikm18/Project-Vedha@0b7bcb82f82922f901d24413b10ed114e096a3a7": "0b7bcb8 feat: probe bootstrap key — self-register without admin login" | kind=Commit | source=git | neighbors=[agent.py, transport.py, config.py, feat/coverage-gated-auto-resolution, feat/syn-scanner-osfp-adaptive, integration/all-branches]
