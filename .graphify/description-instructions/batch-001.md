# Node Description Batch 2 of 186
...
- "scanner_scanner_base": "scanner_base.py" | kind=code-symbol | source=probe/scanner/scanner_base.py:L1 | neighbors=[engine.py, 10dfc80 Add comprehensive probe testing…, 4d0377d Add unit tests for SMB scanner,…, d1b4dd3 trim frontend to 7 core pages; …, pipeline.py, run_scan.py]
...
- "agent_engine": "engine.py" | kind=code-symbol | source=probe/agent/engine.py:L1 | neighbors=[_applied_tuning(), _build_run_stats(), _clamp(), _count_open_port_facts(), _derive_post_stage(), _env_number()]
