# Node Description Batch 2 of 236
...
- "scanner_scanner_base": "scanner_base.py" | kind=code-symbol | source=probe/scanner/scanner_base.py:L1 | neighbors=[engine.py, local_run.py, 10dfc80 Add comprehensive probe testing…, 22701ea Add tests for scanner parity an…, 2c53ae9 evasion(scanner): randomized sc…, 37376de hardening(scanner): OPSEC de-si…]
...
- "workflow_workflow_engine": "workflow_engine.py" | kind=code-symbol | source=probe/workflow/workflow_engine.py:L1 | neighbors=[engine.py, local_run.py, 10dfc80 Add comprehensive probe testing…, 22701ea Add tests for scanner parity an…, 3ad95f4 feat: Optimize asset service fe…, bb0ef3d feat(probe): route DB services …]
...
- "scan_page": "page.tsx" | kind=code-symbol | source=manager/frontend/app/scan/page.tsx:L1 | neighbors=[10dfc80 Add comprehensive probe testing…, 1fe16c8 stable but some dead code, need…, 30261eb feat: enhance advisor flow with…, 81c81cb feat: implement outbox reclaim …, a789cca scanner: real use-case library,…, b393dbe feat: Enhance Sidebar UI and in…]
- "scanner_findings": "findings.py" | kind=code-symbol | source=probe/scanner/findings.py:L1 | neighbors=[22701ea Add tests for scanner parity an…, _as_dict(), build_service_index(), _by_target(), _corr_anon_data_exposure(), _corr_cleartext_cluster()]
