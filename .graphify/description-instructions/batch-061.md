# Node Description Batch 62 of 144
...
- "detection_engine_vuln_db_clear_caches": "_clear_caches()" | kind=code-symbol | source=manager/detection_engine/vuln_db.py:L133 | neighbors=[vuln_db.py, Test hook: drop the memoized snapshot c…]
- "detection_engine_vuln_db_vulndb_build_cve_index": "._build_cve_index()" | kind=code-symbol | source=manager/detection_engine/vuln_db.py:L92 | neighbors=[VulnDB, .__init__()]
- "detection_engine_vuln_db_vulndb_init": ".__init__()" | kind=code-symbol | source=manager/detection_engine/vuln_db.py:L86 | neighbors=[VulnDB, ._build_cve_index()]
...
- "detection_resolution_apply_manual_reopen": "apply_manual_reopen()" | kind=code-symbol | source=manager/backend/app/detection/resolution.py:L131 | neighbors=[resolution.py, Operator reopens an auto/'manually'-res…]
- "detection_resolution_resolutionoutcome": "ResolutionOutcome" | kind=code-symbol | source=manager/backend/app/detection/resolution.py:L65 | neighbors=[resolution.py, decide_resolution()]
