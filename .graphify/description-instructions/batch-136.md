# Node Description Batch 137 of 186
...
- "routers_agents_agentbootstraprequest_validate_network_segments": ".validate_network_segments()" | kind=code-symbol | source=manager/backend/app/routers/agents.py:L575 | neighbors=[AgentBootstrapRequest] | lang=en
...
- "routers_agents_enqueuejobrequest_validate_uc": "._validate_uc()" | kind=code-symbol | source=manager/backend/app/routers/agents.py:L348 | neighbors=[EnqueueJobRequest] | lang=en
...
- "routers_agents_list_agents": "list_agents()" | kind=code-symbol | source=manager/backend/app/routers/agents.py:L755 | neighbors=[agents.py] | lang=en
...
- "routers_agents_rationale_548": "Allows a probe to register without an admin-issued PAT.      The manager must ha" | kind=entity | source=manager/backend/app/routers/agents.py:L548 | neighbors=[bootstrap_agent()] | lang=en
