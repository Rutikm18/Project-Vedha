# Node Description Batch 89 of 236
...
- "workers_outbox_handle_notify": "_handle_notify()" | kind=code-symbol | source=manager/backend/app/workers/outbox.py:L138 | neighbors=[outbox.py, Fan a notification out to the tenant's …, Fan a notification out to the tenant's …]
...
- "workflow_asset_asset_merge_host_discovery": "._merge_host_discovery()" | kind=code-symbol | source=probe/workflow/asset.py:L111 | neighbors=[Asset, _parse_ts(), PortFact]
- "workflow_asset_asset_merge_port_scan": "._merge_port_scan()" | kind=code-symbol | source=probe/workflow/asset.py:L121 | neighbors=[Asset, _parse_ts(), PortFact]
- "workflow_asset_asset_merge_udp_scan": "._merge_udp_scan()" | kind=code-symbol | source=probe/workflow/asset.py:L207 | neighbors=[Asset, _parse_ts(), PortFact]
...
- "workflow_router_looks_like_ssh": "looks_like_ssh()" | kind=code-symbol | source=probe/workflow/router.py:L71 | neighbors=[router.py, True when a service banner is an SSH id…, route_branches()]
- "workflow_workflow_engine_run_inventory": "_run_inventory()" | kind=code-symbol | source=probe/workflow/workflow_engine.py:L211 | neighbors=[workflow_engine.py, run_engagement(), _Sink]
- "workflow_workflow_engine_run_passive": "_run_passive()" | kind=code-symbol | source=probe/workflow/workflow_engine.py:L194 | neighbors=[workflow_engine.py, run_engagement(), _Sink]
